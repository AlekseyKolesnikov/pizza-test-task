...
const ItemList = ({items, currency, basket, addToBasket, removeFromBasket, showDetails}) => {
    return (
        <div className="container mt-5 py-5 d-flex flex-wrap justify-content-around bg-greeny shadow-sm">
            {items.map(item => {
                ...
                return <Item key={item.id} item={item} currency={currency} qnt={basketItem ? basketItem.qnt : 0}
